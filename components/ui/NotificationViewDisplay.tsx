...
export default function NotificationViewDisplay({ id, receiver_id, sender_id, pointer_type, pointer_id, created_at, is_read, sender_username, sender_image }: NotificationViewDisplay) {
